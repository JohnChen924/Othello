...
public:
    ...
    void setrow(bool edit);
    void setcolumn(bool edit);
    void columnse(bool edit);
    void inputting(char c);
    void newline();
    void deleteline();
    void backspace();
    void undobackspace(unsigned int undocolumn, char undoc);
    char getcharacter();
    void undodown(unsigned int down);
    std::string getline(unsigned int row);
    void undodeleteline(std::string txt, unsigned int r,unsigned int c);
    void undonewline(unsigned int r,unsigned int c);
    //void setline(bool edit);
